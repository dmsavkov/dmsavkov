...
**Machine Learning Engineer | Agentic AI** · SPbU MatMeh

## Featured Projects

**[LogGuard](https://github.com/dmsavkov/Log-Guard)** — CI logs exceed LLM context; `lg run` compresses them into failure-preserving timelines.
...
**[Uni-Judge Research](https://github.com/dmsavkov/DatasetLabeling)** — Can LLM judges replace classical classifiers with only dozens of labels?
...
**[Bad-Weather-Notifier](https://github.com/dmsavkov/Bad-Weather-Notifier)** — Location-specific severe-weather alerts.
...
<details>
<summary>The Human Side</summary>
